package com.seijind.todo.ui.list.composable
...
import com.seijind.todo.ui.list.TodoListAction
import com.seijind.todo.ui.list.TodoListState
...
fun TodoListScreen(
    ...
    state.errorMessage?.let { error ->
        LaunchedEffect(error) {
            snackbarHostState.showSnackbar(error.asStringAsync())
            onAction(TodoListAction.DismissError)
        }
    }
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Todos") },
                actions = {
                    IconButton(onClick = { onAction(TodoListAction.SettingsClicked) }) {
                        Text("⚙")
                    }
                },
            )
